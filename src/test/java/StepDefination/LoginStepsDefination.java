...
public class LoginStepsDefination {
	...
	public void i_should_land_on_the_home_page() {
	    // Write code here that turns the phrase above into concrete actions
		System.out.println(" Pass as we have given incorrect username and password");
	}
	...
	@And("I click on the login link")   //we can use given and and both but and work everywhere
